...
$currentLogPath = $currentPath + "\" + "CheckUserPermissionOnSite.txt"


#Permission Report
#$csvPath = "$currentPath\Site_Permission_Report_" + $currentDateTime +".csv"
$csvPath = "$currentPath\Site_Permission_Report.csv"
set-content $csvPath "Site Name,List Name, Item Title, User Name, Permission"


# Initialize client context
$siteUrl = 'https://brspdev.sharepoint.com/sites/BRDev'
...
$SearchUser = "sanjay@brspdev.onmicrosoft.com"
