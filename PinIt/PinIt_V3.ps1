...
Add-PnPTaxonomyField -List $ListName  -DisplayName "Keyword" -InternalName "Keyword" -TermSetPath "PinIt|Keywords" -AddToDefaultView
...
$FieldXML= "<Field Type='User' Name='User1' ID='$([GUID]::NewGuid())' DisplayName='User' Required ='FALSE' UserSelectionMode='PeopleAndGroups' Mult='TRUE' ></Field>"
